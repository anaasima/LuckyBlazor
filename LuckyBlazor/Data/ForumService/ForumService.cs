...
namespace LuckyBlazor.Data.ForumService
{
    public class ForumService : IForumService
    {
        public async Task<IList<Post>> GetAllPosts()
        {
            ...
            string uri = "https://localhost:8080/posts"; 
        ...
        {
            HttpClient httpClient = new HttpClient();
            string uri = "https://localhost:8080/posts/" + userId;
            string message = await httpClient.GetStringAsync(uri);
            IList<Post> result = JsonSerializer.Deserialize<IList<Post>>(message);
            return result;
        }
        ...
        public async Task CreatePost(Post post)
        {
            ...
            HttpResponseMessage responseMessage = await httpClient.PostAsync
                ("https://localhost:8080/posts", content);
        ...
        public async Task CreateComment(Comment comment)
        {
            ...
            HttpResponseMessage responseMessage =
                await httpClient.PostAsync("https://localhost:8080/postComment", content);
            Console.WriteLine(responseMessage.StatusCode.ToString());
        }
        ...
        public async Task SavePosts(Post post, int userId)
        {
            ...
            HttpResponseMessage responseMessage = await httpClient.PostAsync($"https://localhost:8080/savedPosts/{userId}", content);
            Console.WriteLine(responseMessage.StatusCode.ToString());
        }
        ...
        {
            HttpClient httpClient = new HttpClient();
            HttpResponseMessage responseMessage = await httpClient.DeleteAsync($"https://localhost:8080/posts/{id}");
            Console.WriteLine(responseMessage.StatusCode.ToString());
        }
        ...
        public async Task ReportPost(Report report)
        {
            ...
            HttpResponseMessage responseMessage = await httpClient.PostAsync("https://localhost:8080/report", content);
            Console.WriteLine(responseMessage.StatusCode.ToString());
        }
        ...
        {
            HttpClient httpClient = new HttpClient();
            HttpResponseMessage responseMessage = await httpClient.DeleteAsync($"https://localhost:8080/reports/{id}");
            Console.WriteLine(responseMessage.StatusCode.ToString());
        }
        ...
        {
            HttpClient httpClient = new HttpClient();
            string uri = "https://localhost:8080/reports"; 
            string message = await httpClient.GetStringAsync(uri);
        ...
        public async Task EditPost(Post post)
        {
            ...
            HttpResponseMessage responseMessage = await httpClient.PatchAsync("https://localhost:8080/posts", content);
            Console.WriteLine(responseMessage.StatusCode.ToString());
        }
        public async Task<IList<Post>> GetSavedPosts(int userId)
        {
            HttpClient httpClient = new HttpClient();
            string uri = $"https://localhost:8080/savedPosts/{userId}";
            string message = await httpClient.GetStringAsync(uri);
